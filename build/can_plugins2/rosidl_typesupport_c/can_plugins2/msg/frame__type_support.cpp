...
static const _Frame_type_support_symbol_names_t _Frame_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, can_plugins2, msg, Frame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, can_plugins2, msg, Frame)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, can_plugins2, msg, Frame)() {
  return &::can_plugins2::msg::rosidl_typesupport_c::Frame_message_type_support_handle;
}
